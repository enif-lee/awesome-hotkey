...
// https://www.freecodecamp.org/news/javascript-keycode-list-keypress-event-key-codes/ + toLowerCase
export const EventKeyKeycapMap: Record<string, KeycapType> = {
    'Backspace': KeycapType.Backspace,
    'Tab': KeycapType.Tab,
    'Enter': KeycapType.Enter,
    'Shift': KeycapType.Shift,
    'Control': KeycapType.Ctrl,
    'Alt': KeycapType.Alt,
